...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Bulan Mei 2023 pada 07.05
...
--
ALTER TABLE `tb_guru`
  ADD CONSTRAINT `tb_guru_ibfk_1` FOREIGN KEY (`id`) REFERENCES `tb_user` (`id`);

--
-- Ketidakleluasaan untuk tabel `tb_nilai_ujian`
--
ALTER TABLE `tb_nilai_ujian`
  ADD CONSTRAINT `tb_nilai_ujian_ibfk_2` FOREIGN KEY (`no_ujian`) REFERENCES `tb_ujian` (`no_ujian`),
  ADD CONSTRAINT `tb_nilai_ujian_ibfk_3` FOREIGN KEY (`id`) REFERENCES `tb_user` (`id`);
...
--
ALTER TABLE `tb_user`
  ADD CONSTRAINT `tb_user_ibfk_1` FOREIGN KEY (`id`) REFERENCES `tb_sekolah` (`id`);
COMMIT;
